...
class MusicPlayerView(Frame):
    ...
    def create_buttons(self):
        button_options = [("ADD TO LIST", self.model.load_songs_into_playlist), 
        ...
        for row_number, button_option in enumerate(button_options):
            ...
            button.grid(row=row_number, column=0)
